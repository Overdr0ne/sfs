...
** Recording
    You can also *record* your queries to recollections described in the next section. When you *record* a query, it can inserted into the recollections hierarchy using '.' as a separator like you would a file.at.some.path.
